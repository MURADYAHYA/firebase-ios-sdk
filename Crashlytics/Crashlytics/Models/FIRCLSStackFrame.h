 ...
 *and can influence crash grouping. Be particularly careful with the use of the address property. If
 *set, Crashlytics will attempt symbolication and could overwrite other properities in the process.
 *
 **/
